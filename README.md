...
Una combinación de causas, ya sean estas individuales o diversas pueden llevar a un mismo tipo de falla o severidad en la interrupción del servicio, una vez clasificadas, la pregunta a contestar es: Con una combinación especifica de factores ¿Qué tipo se falla puede presentarse? para de esta manera prevenirlas. 
